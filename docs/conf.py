...
html_context = {
    ...
    "github_url": "https://github.com/canonical/sloth-k8s-operator",
...
# Your manpage URL
#
# NB: To enable manpage links, uncomment and replace {codename} with required
